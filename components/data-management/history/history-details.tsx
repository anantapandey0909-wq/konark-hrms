        ...
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <CardDescription className="text-xs text-zinc-500">
              Selected execution parameters from the audit log.
            </CardDescription>
          </div>
        </div>
      </CardHeader>
      <CardContent className="p-5 space-y-4 text-xs font-medium text-zinc-500">
        {!job ? (
          <p className="text-xs text-zinc-500 leading-relaxed py-4">
            Select a pipeline job to inspect audit details.
          </p>
        ) : (
          <>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-bold uppercase tracking-wider text-[10px] text-zinc-450">
                  Diagnostic Metrics
                </span>
              </div>
