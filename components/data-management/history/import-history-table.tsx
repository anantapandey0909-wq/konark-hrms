...
import { History, FileSpreadsheet, CheckCircle, AlertCircle, ArrowUpRight, ArrowDownLeft } from 'lucide-react';
        ...
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <CardDescription className="text-xs text-zinc-500">
              Audit log of import, export, and bulk operations for this organization.
            </CardDescription>
          </div>
        </div>
      </CardHeader>
        ...
        <div className="overflow-x-auto">
          <Table className="text-xs text-left w-full min-w-[750px]">
            ...
            <TableBody className="divide-y divide-zinc-100 dark:divide-zinc-800/60">
              {isLoading ? (
                <TableRow>
                  <TableCell colSpan={6} className="px-5 py-10 text-center text-zinc-500">
                ...
                <TableRow>
                  <TableCell colSpan={6} className="px-5 py-10 text-center text-zinc-500">
                    No import, export, or bulk operations have been recorded yet.
                  </TableCell>
                </TableRow>
              ) : (
                jobs.map((row) => {
                  ...
                  return (
                    <TableRow
                      ...
                      className={
                        'cursor-pointer transition-colors border-b border-zinc-100 dark:border-zinc-800/80 ' +
                        (isSelected
                      ...
                      <TableCell className="px-5 py-4 font-semibold text-zinc-900 dark:text-zinc-100">
                        <div className="flex items-center space-x-2.5">
                          ...
                          <div>
                            ...
                            <p
                              className="font-bold text-zinc-800 dark:text-zinc-200 truncate max-w-[160px]"
                              title={row.fileName}
                            >
                              {row.fileName}
                            </p>
