...
import { FileSpreadsheet, CheckCircle, AlertTriangle, AlertCircle, Timer } from 'lucide-react';
...
const mockMetrics: SummaryMetric[] = [
  ...
  },
  {
    ...
    count: 0,
    icon: AlertCircle,
    colorClass: 'text-zinc-600 dark:text-zinc-400 bg-zinc-50 dark:bg-zinc-800 border-zinc-150'
  },
  {
