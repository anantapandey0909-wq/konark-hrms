...
export default function AttendanceTemplateCard() {
  const templateConfig = {
    title: 'Attendance Import Template',
    formats: 'XLSX / CSV supported',
    requiredColumns: 8,
    maxRecommendedRows: '10,000 max rows per batch',
  };
        ...
        <CardContent className="p-5 space-y-4">
          <div className="space-y-1.5">
            ...
            <p className="text-[11px] text-zinc-500 dark:text-zinc-400 leading-normal">
              Verify biometric terminal formatting columns before executing synchronization.
            </p>
          </div>
