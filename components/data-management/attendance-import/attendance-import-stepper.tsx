...
export default function AttendanceImportStepper() {
  const steps: StepItem[] = [
    {
      number: 1,
      label: 'Download Attendance Template',
      desc: 'Retrieve biometric layout spreadsheet',
      icon: Download,
      status: 'completed',
    },
    {
      number: 2,
      label: 'Select Attendance File',
      desc: 'Load device terminal logs',
      icon: Upload,
      status: 'completed',
    },
    {
    ...
    },
    {
      ...
      desc: 'Sync logs with database layer',
      icon: CheckCircle,
      status: 'upcoming',
    },
  ];
