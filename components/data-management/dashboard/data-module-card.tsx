...
export default function DataModuleCard({ module }: DataModuleCardProps) {
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Card className="h-full border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 shadow-sm overflow-hidden select-none">
        <CardContent className="p-5 flex flex-col justify-between h-full space-y-5">
          <div className="space-y-3.5">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className={`capitalize border text-[10px] px-2 py-0.5 font-bold tracking-wide ${statusColors[module.status]}`}>
                {module.status}
              </Badge>
            </div>
          ...
          <div className="pt-3 border-t border-zinc-100 dark:border-zinc-800/80 space-y-2 text-[10px]">
            ...
            {/* Subtitle details */}
            <div className="pt-2 flex items-center justify-between border-t border-dotted border-zinc-150 dark:border-zinc-800 text-zinc-400 dark:text-zinc-500">
