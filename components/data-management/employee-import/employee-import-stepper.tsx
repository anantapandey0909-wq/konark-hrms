...
export default function EmployeeImportStepper() {
  const steps: StepItem[] = [
    {
      number: 1,
      label: 'Download Template',
      desc: 'Retrieve standard formatting sheet',
      icon: Download,
      status: 'completed',
    },
    {
    ...
    },
    {
      number: 3,
      label: 'Review Data',
      desc: 'Perform dynamic cell-checks',
      icon: Eye,
      status: 'active',
    },
    {
      ...
      desc: 'Commit verified lines to system',
      icon: CheckCircle,
      status: 'upcoming',
    },
  ];
