...
export default function MasterDataImportStepper() {
  const steps: StepItem[] = [
    {
      number: 1,
      label: 'Download Schema Template',
      desc: 'Retrieve organizational coordinate model',
      icon: Download,
      status: 'completed',
    },
    {
      number: 2,
      label: 'Select Master File',
      desc: 'Load structure lines into safe memory',
      icon: Upload,
      status: 'completed',
    },
    {
      number: 3,
      label: 'Review Structure Mappings',
      desc: 'Confirm hierarchies and code links',
      icon: Eye,
      status: 'active',
    },
    {
      ...
      desc: 'Commit structures to active database',
      icon: CheckCircle,
      status: 'upcoming',
    },
  ];
