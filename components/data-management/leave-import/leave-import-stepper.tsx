...
export default function LeaveImportStepper() {
  const steps: StepItem[] = [
    {
      number: 1,
      label: 'Download Leave Template',
      desc: 'Retrieve standard absence mapping sheet',
      icon: Download,
      status: 'completed',
    },
    {
      number: 2,
      label: 'Select Leave File',
    ...
    {
      number: 3,
      label: 'Review Leave Records',
      desc: 'Perform dynamic duration checks',
      icon: Eye,
      status: 'active',
    },
    {
      ...
      desc: 'Sync allocations with platform database',
      icon: CheckCircle,
      status: 'upcoming',
    },
  ];
