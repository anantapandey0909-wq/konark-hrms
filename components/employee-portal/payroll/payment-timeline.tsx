    ...
    <Card className="shadow-sm">
      ...
      <CardContent className="pt-5">
        <div className="mb-4 rounded-lg bg-slate-50 p-3 dark:bg-slate-900/30 border border-slate-100/50 dark:border-slate-800/50">
          <div className="text-xs font-bold text-slate-900 dark:text-slate-100">Period: {timeline.payPeriod}</div>
          <div className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5">Disbursement Date: {timeline.disbursementDate}</div>
        </div>
